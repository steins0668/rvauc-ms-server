...
export namespace SessionManager {
  export async function createService() {
    ...
    return new Service(sessionTokenRepository, userSessionRepository);
  }

  export class Service {
    private readonly _cleanup: SessionCleaner;
    ...
    constructor(
      ...
      this._cleanup = new SessionCleaner(userSessionRepository);
