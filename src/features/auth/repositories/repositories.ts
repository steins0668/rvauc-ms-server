export { ProfessorRepository as Professor } from "./professor.repository";
export { RoleRepository as Role } from "./role.repository";
export { SessionTokenRepository as SessionToken } from "./session-token.repository";
export { SignInRequestRepository as SignInRequest } from "./sign-in-request.repository";
