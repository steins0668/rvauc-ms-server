...
export namespace Errors {
  export namespace Authentication {
    export type ErrorName =
      ...
      | "AUTHENTICATION_PAYLOAD_CREATION_ERROR"
      | "AUTHENTICATION_PAYLOAD_VALIDATION_ERROR"
    ...
    export const statusCodeMap: Exhaustive<ErrorName> = {
      ...
      AUTHENTICATION_PAYLOAD_CREATION_ERROR: 500,
      AUTHENTICATION_PAYLOAD_VALIDATION_ERROR: 500,
