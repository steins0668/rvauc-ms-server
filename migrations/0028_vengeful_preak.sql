...
INSERT INTO `__new_users`("id", "rfid_uid_hash", "role_id", "email", "username", "password_hash", "surname", "first_name", "contact_number") SELECT "id", "rfid_uid_hash", "role_id", "email", "username", "password_hash", "surname", "first_name", "contact_number" FROM `users`;--> statement-breakpoint
