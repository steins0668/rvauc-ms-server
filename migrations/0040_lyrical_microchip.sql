...
CREATE TABLE `__new_attendance_records` (
	...
	`class_offering_id` integer DEFAULT 1 NOT NULL,
...
INSERT INTO `__new_attendance_records`("id", "student_id", "class_id", "class_offering_id", "status", "record_count", "recorded_at", "recorded_ms", "date_ph") SELECT "id", "student_id", "class_id", "class_offering_id", "status", "record_count", "recorded_at", "recorded_ms", "date_ph" FROM `attendance_records`;--> statement-breakpoint
