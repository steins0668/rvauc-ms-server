...
INSERT INTO `__new_attendance_records`("id", "enrollment_id", "class_id", "class_session_id", "status", "created_at", "record_count", "recorded_at", "recorded_ms", "updated_at", "updated_by_user_id", "date_ph") SELECT "id", "enrollment_id", "class_id", "class_session_id", "status", "created_at", "record_count", "recorded_at", "recorded_ms", "updated_at", "updated_by_user_id", "date_ph" FROM `attendance_records`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `uidx_attendance_records_enrollment_id_class_session_id_date_ph` ON `attendance_records` (`enrollment_id`,`class_session_id`,`date_ph`);