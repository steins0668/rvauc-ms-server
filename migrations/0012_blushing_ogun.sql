...
INSERT INTO `__new_violation_records`("id", "student_id", "status_id", "number", "date", "reasons", "compliance_record_id") SELECT "id", "student_id", "status_id", "number", "date", "reasons", "compliance_record_id" FROM `violation_records`;--> statement-breakpoint
